...
!-----------------------------------------------------------------------------
    ...
    do shell=1, n_shells
      ...
      do nn1=1, this%n_nn(i1s,shell)
        ...
        if (e_pars%int_energy_pars(i1,i1s,i1a,i2,i2s,i2a,shell,nn1) /= &
          ...
          do nn2=1, this%n_nn(i2s,shell)
            if ( all( this%shell_list(i2s,shell,nn2,:) == - this%shell_list(i1s,shell,nn1,:) ) ) then
              e_pars%int_energy_pars(i2,i2s,i2a,i1,i1s,i1a,shell,nn2) = &
                e_pars%int_energy_pars(i1,i1s,i1a,i2,i2s,i2a,shell,nn1)
              exit
            end if
          end do
